"""Generate data collection checklist documentation."""
...
def main() -> None:
    output_dir = Path("reports/data_collection")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_path = output_dir / "data_collection_recommendations.md"
    output_path.write_text(_checklist_text(), encoding="utf-8")
    print(f"Data collection checklist saved to {output_path}")
